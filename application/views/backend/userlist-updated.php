                            ...
                            <table id="example" class="table table-condensed responsive table_custom" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>crud/View_profile?U=<?php echo base64_encode($value->user_id) ?>"><?php echo $value->full_name ?></a></td>
                                        <td>
        ...
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                ...
                theForm.find('[name="userid"]').val(response.uservalue.user_id).end()
                        ...
                        .find('[name="address"]').val(response.uservalue.address).end()
                        .find('[name="dob"]').val(response.uservalue.dob).end()
                        .find('[name="country"]').val(response.uservalue.country).end()
                        .find('[name="gender"]').val(response.uservalue.gender).end()
                        .find('[name="role"]').val(response.uservalue.user_type).end();
